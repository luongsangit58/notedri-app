...
// tổng hợp mọi xe - xem DashboardScreen.tsx). Nơi nào chỉ dùng dashboard của 1
// xe cụ thể (HomeScreen) tự truyền enabled:!!vehicleId để không bắn 1 round-trip
// "mọi xe" thừa rồi vứt ngay khi vehicleId thật về tới (sửa 15/7).
